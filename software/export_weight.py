...
if __name__ == '__main__':
    ...
    # export weight
    weights_file = open(f'/home/quocna/project/DOAN2/fire_detec/software/txt/weights.txt', 'w')

    weight_data = ''
    weight_addr = []
    weight_base_addr = 0000_0000
    output_parallel = [16, 16, 16, 16, 16, 1]
    ...
    for i, addr in enumerate(weight_addr):
        weights_file.write(Fxp(addr, signed=False, n_word=64, n_frac=0).hex()[2:].lower() + weight_data[0:16][::-1].lower() + '\n')
